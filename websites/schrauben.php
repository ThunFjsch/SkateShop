<html>
		...
		<div class="inputField">		<!--Class for Css-->
			<form method="post">
				<ul>
					...
					<li>Schrauben Typ: <input type="text" name="txt_SchraubenTYPEN"></li><br>
					<li>Schrauben Preis: <input type="text" name="txt_SchraubenHERSTELLER"></li><br>
					<li>Schrauben Hersteller: <input type="text" name="txt_SchraubenPREIS"></li>
					<br><br>
	...
	<?php
		...
		while($ds=$res->fetch_object()){
			echo "<tr>";
			echo "<td>".$ds->ID."</td><td>".$ds->SchraubenTYPEN."</td><td>".$ds->SchraubenPREIS."</td><td>".$ds->SchraubenHERSTELLER."</td>";
			echo "</tr>"; 
