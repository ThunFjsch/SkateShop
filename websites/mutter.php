<html>
		...
		<div class="inputField">		<!--Class for Css-->
			<form method="post">
				<ul>
					...
					<li>Mutter Typ: <input type="text" name="txt_MutterTYP"></li><br>
					<li>Mutter Preis: <input type="text" name="txt_MutterPREIS"></li><br>
					<li>Mutter Hersteller: <input type="text" name="txt_MutterHERSTELLER"></li>
					<br><br>
	...
	<?php
		...
		while($ds=$res->fetch_object()){
			echo "<tr>";
			echo "<td>".$ds->ID."</td><td>".$ds->MutterTYP."</td><td>".$ds->MutterPREIS."</td><td>".$ds->MutterHERSTELLER."</td>";
			echo "</tr>"; 
