<html>
	...
	<body>
		...
		<div class="inputField">		<!--Class for Css-->
			<form method="post">
				<ul>
					...
					<li>Griptape Typ: <input type="text" name="txt_GriptapeMATERIAL"></li><br>
					<li>Griptape Preis: <input type="text" name="txt_GriptapePREIS"></li><br>
					<li>Griptape Hersteller: <input type="text" name="txt_GriptapeHERSTELLER"></li>
					<br><br>
		...
		<?php
			if(isset($_POST['txt_GriptapeMATERIAL'])) {
				$GriptapeMATERIAL = $_POST['txt_GriptapeMATERIAL'];
				...
				$db->query("INSERT INTO Griptape (GriptapeMATERIAL,GriptapePREIS,GriptapeHERSTELLER) VALUES ('$GriptapeMATERIAL','$GriptapePREIS','$GriptapeHERSTELLER');");
				$db->close();
			}
		?>
	...
	<?php
		...
		while($ds=$res->fetch_object()){
			echo "<tr>";
			echo "<td>".$ds->ID."</td><td>".$ds->GriptapeMATERIAL."</td><td>".$ds->GriptapePREIS."</td><td>".$ds->GriptapeHERSTELLER."</td>";
			echo "</tr>"; 
