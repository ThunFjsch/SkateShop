<html>
		...
		<div class="inputField">		<!--Class for Css-->
			<form method="post">
				<ul>
					...
					<li>Räder Typ: <input type="text" name="txt_RaederMATERIAL"></li><br>
					<li>Räder Preis: <input type="text" name="txt_RaederHERSTELLER"></li><br>
					<li>Räder Hersteller: <input type="text" name="txt_RaederPREIS"></li>
					<br><br>
	...
	<?php
		...
		while($ds=$res->fetch_object()){
			echo "<tr>";
			echo "<td>".$ds->ID."</td><td>".$ds->RaederMATERIAL."</td><td>".$ds->RaederPREIS."</td><td>".$ds->RaederHERSTELLER."</td>";
			echo "</tr>"; 
